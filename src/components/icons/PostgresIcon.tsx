...
export type PostgresIconProps = {
  backgroundVariants: Variants;
  eyeVariants: Variants;
  outline1Variants: Variants;
  outline2Variants: Variants;
};
